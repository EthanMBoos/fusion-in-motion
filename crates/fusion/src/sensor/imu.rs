use fusion_schema::messages::{ImuEffectsTruth, ImuSample, observation_truth};
...
use super::{
    PendingMeasurement, build_observation_truth, period_ns, record_header, seconds_to_ns, to_proto,
};
    ...
    while sample_end_ns <= end_ns {
        ...
        output.push(PendingMeasurement {
            ...
            observation_truth: Some(build_observation_truth(
                ...
                sample_end_ns,
                arrival_ns,
                observation_truth::IdealObservation::IdealImu(ideal_observation),
                Some(ImuEffectsTruth {
